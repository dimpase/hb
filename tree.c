...
static void	sprout	__PPP( (tree **, tree_t, int *, int (*)(), void (*)()) );
static int	delete	__PPP( (tree **, int (*)(), tree_t, void (*)(),
			      int *, int *) );
static void	del	__PPP( (tree **, int *, tree **, void (*)(), int *) );
static void	bal_L	__PPP( (tree **, int *) );
static void	bal_R	__PPP( (tree **, int *) );
